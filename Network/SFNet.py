...
class SFNet(nn.Module):
    def __init__(self, in_channels=3, base_c=32, num_classes=2, bilinear: bool = True):
        ...
        self.fusiondown1 = DoubleConv(base_c * 2, base_c)
        self.fusiondown2 = DoubleConv(base_c * 4, base_c * 2)
        self.fusiondown3 = DoubleConv(base_c * 8, base_c * 4)
        self.fusiondown4 = DoubleConv(base_c * 16, base_c * 8)
        self.fusiondown5 = DoubleConv(base_c * 32 // factor, base_c * 16 // factor)
    ...
    def forward(self, x: torch.Tensor):
        ...
        feat1 = torch.concat((feat1, dwtf1), 1)
        feat1 = self.fusiondown1(feat1)
        feat2 = torch.concat((feat2, dwtf2), 1)
        feat2 = self.fusiondown2(feat2)
        feat3 = torch.concat((feat3, dwtf3), 1)
        feat3 = self.fusiondown3(feat3)
        feat4 = torch.concat((feat4, dwtf4), 1)
        feat4 = self.fusiondown4(feat4)
        feat5 = torch.concat((feat5, dwtf5), 1)
